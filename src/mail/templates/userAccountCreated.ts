interface UserAccountCreatedData {
  email: string;
  tempPassword: string;
...
export const generateUserAccountCreatedEmail = (
...
<head>
  ...
  <title>Welcome to Your Journi Account</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${process.env.USER_FRONTEND_URL}/login" class="button">Login to Your Account</a>
