interface UserPasswordResetSuccessData {
  changedAt: Date;
}

export const generateUserPasswordResetSuccessEmail = (
  data: UserPasswordResetSuccessData,
): string => {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${process.env.USER_FRONTEND_URL}/login" class="button">Login Now</a>
